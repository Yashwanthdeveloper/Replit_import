    ...
    run: async (bot, message, args) => {
        ...
        if (args.join(' ').toLocaleLowerCase() == 'nikes') {
            let embed1 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:918021129401139250:92824529037965727>  You don't have Nikes to sell`);
            ...
            let embed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:918021129401139250:92824529037965727>  Sold Fresh Nikes For 600 Coins`);
            ...
            let embed4= new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:918021129401139250:92824529037965727>  Sold a Car For 800 Coins`);
            ...
            let sembed2 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:918021129401139250:92824529037965727>  You don't have a Mansion to sell`);
            ...
            let sembed3 = new MessageEmbed()
                .setColor("GREEN")
                .setDescription(`<a:918021129401139250:92824529037965727>  Sold a Mansion For 1200 Coins`);
            ...
            if (message.content.toLowerCase() === `${prefix}sell`) {
                let embed9 = new MessageEmbed()
                    .setColor("GREEN")
                    .setDescription(`<a:918021129401139250:928245290379657278>  Enter an item to sell. Type ${prefix}store to see list of items`)
